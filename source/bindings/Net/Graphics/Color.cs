...
namespace SFML.Graphics
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        /// <summary>Red component of the color (0.0-1.0)</summary>
        public float Rf => R / 255f;

        /// <summary>Green component of the color</summary>
        public byte G;

        /// <summary>Green component of the color (0.0-1.0)</summary>
        public float Gf => G / 255f;

        /// <summary>Blue component of the color</summary>
        public byte B;

        /// <summary>Blue component of the color (0.0-1.0)</summary>
        public float Bf => B / 255f;

        /// <summary>Alpha (transparent) component of the color</summary>
        public byte A;

        /// <summary>Alpha (transparent) component of the color (0.0-1.0)</summary>
